...
test('shoud setup add expense action object with provided values', () => {
    const actions = addExpense(expenses[2]);
...
test('should add expense to database and strore', (done) => {
    const store = createMockStore({});
    const expenseData = {
        description: 'Mouse',
        amount: 3000,
...
test('should add expense with defaults to database and strore', (done) => {
    const store = createMockStore({});
